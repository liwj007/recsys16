    ...
    WHILE s <> 1 DO
        ...
        IF dpl <> 0 THEN
            ...
            while i <= 42 do
                ...
                UPDATE small_sample 
                #
                SET sj_dis_1_1_p=p3,sj_dis_1_1_n=n3,sj_dis_2_1_p=(p2+p3),sj_dis_2_1_n=(n2+n3),sj_dis_2_2_p=(p1+p2+p3),sj_dis_2_2_n=(n1+n2+n3)
                #
                WHERE i_discipline_id = dpl 
                AND serial = ser;
