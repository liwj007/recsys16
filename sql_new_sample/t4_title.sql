...
BEGIN
	...
	DECLARE cur CURSOR FOR SELECT DISTINCT i_title FROM small_sample;
	...
	WHILE s<>1 DO
        ...
        while i<=42 do
					...
					UPDATE small_sample SET sj_title_1_1_p=p3,sj_title_1_1_n=n3,sj_title_2_1_p=(p2+p3),sj_title_2_1_n=(n2+n3),sj_title_2_2_p=(p1+p2+p3),sj_title_2_2_n=(n1+n2+n3) WHERE i_title=t AND serial=ser;
					...
					BEGIN
						...
						WHILE ss<>1 DO
							UPDATE small_sample SET usj_title_1_p=c  WHERE i_title=t AND serial=ser AND user_id=uid;
							FETCH cur2 into uid,c;
						END WHILE;
						CLOSE cur2;
					END;
					...
					BEGIN
						...
						FETCH cur2 into uid,c;
						WHILE ss<>1 DO
							UPDATE small_sample SET usj_title_2_p=c  WHERE i_title=t AND serial=ser AND user_id=uid;
							FETCH cur2 into uid,c;
						END WHILE;
						CLOSE cur2;
					END;
					...
					BEGIN
						...
						FETCH cur2 into uid,c;
						WHILE ss<>1 DO
							UPDATE small_sample SET usj_title_3_p=c  WHERE i_title=t AND serial=ser AND user_id=uid;
							FETCH cur2 into uid,c;
						END WHILE;
						CLOSE cur2;
					END;
				...
				BEGIN
						...
						FETCH cur2 into uid,c;
						WHILE ss<>1 DO
							UPDATE small_sample SET usj_title_1_n=c  WHERE i_title=t AND serial=ser AND user_id=uid;
							FETCH cur2 into uid,c;
						END WHILE;
						CLOSE cur2;
					END;
					...
					BEGIN
						...
						FETCH cur2 into uid,c;
						WHILE ss<>1 DO
							UPDATE small_sample SET usj_title_2_n=c  WHERE i_title=t AND serial=ser AND user_id=uid;
							FETCH cur2 into uid,c;
						END WHILE;
						CLOSE cur2;
					END;
					...
					BEGIN
						...
						FETCH cur2 into uid,c;
						WHILE ss<>1 DO
							UPDATE small_sample SET usj_title_3_n=c  WHERE i_title=t AND serial=ser AND user_id=uid;
							FETCH cur2 into uid,c;
						END WHILE;
						CLOSE cur2;
					END;
